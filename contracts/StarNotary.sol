...
contract StarNotary is ERC721 {
    ...
    constructor() public ERC721("StarNotary", "SNO"){}
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        require(bytes(tokenIdToStarInfo[_tokenId].name).length > 0, "No item with that tokenId"); 
        
        returnVal = tokenIdToStarInfo[_tokenId].name;
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public payable{
        ...
        require(((msg.sender !=  ownerAddressOfTokenId1) || (msg.sender !=  ownerAddressOfTokenId2)), "Non of the tokens owned by sender!");

        //4. Use _transferFrom function to exchange the tokens.
        _transfer(ownerAddressOfTokenId1, ownerAddressOfTokenId2, _tokenId1);
        _transfer(ownerAddressOfTokenId2, ownerAddressOfTokenId1, _tokenId2);
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require((msg.sender ==  ownerOf(_tokenId)), "Token is not owned by the sender address!" );
